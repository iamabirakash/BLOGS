  ...
  return (
    <nav className="shadow-md flex flex-col md:flex-row justify-between items-center px-8 py-3 rounded-b-2xl fixed top-0 right-0 left-0  backdrop-blur-md z-50">
        ...
        <div className="flex justify-center items-center gap-2">
            ...
            <input type='search' name='search' id='search' autoComplete='off' placeholder='Search Blogs Here...' className="outline-none border-b-2 border-gray-400 text-white focus:border-white bg-transparent transition-all px-2 py-1 md:w-[20vw]"/>
        </div>
    </nav>
  )
}
