        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-col md:flex-row justify-between gap-2 md:gap-0">
            ...
            <button
              ...
              className="py-2 flex px-4 text-base bg-purple-500 hover:bg-purple-400 rounded-3xl text-white font-semibold w-fit">
              Add Tag
            </button>
          </div>
          ...
          <div className="bg-gray-100 rounded-2xl space-y-1">
            {tags.map((tag, i) => (
              <div
                key={i}
